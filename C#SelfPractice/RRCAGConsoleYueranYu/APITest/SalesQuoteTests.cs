...
namespace APITest
{
    ...
    public class SalesQuoteTests
    {
        ...
        [TestMethod]
        public void VehiclePriceChanged_Test()
        {
            ...
            salesQuote.VehiclePriceChanged += TestHandler;
        ...
        [TestMethod]
        public void AccessoriesChosenChanged_Test()
        {
            this.eventActual = null;
            SalesQuote salesQuote = new SalesQuote(20000, 2000, 0.2m, Accessories.ComputerNavigation, ExteriorFinish.Custom);
            salesQuote.AccessoriesChosenChanged += TestHandler;
